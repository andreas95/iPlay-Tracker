...
public class iDocsFragment {
    ...
    public void createPagination() {
        if (TorrentsDB.getTorrentsNo("Docs", search, in, status, categories)!=0) {
    ...
    public List<String> createPageIndex() {
        ...
        total_torrents = TorrentsDB.getTorrentsNo("Docs", search,in,status,categories);
    ...
    public void showPageNo(int no_page, List<String> pages) {
        ...
        ObservableList<Torrent> listTorrents= FXCollections.observableArrayList(
                TorrentsDB.getTorrentsList("Docs", pages.get(no_page),search,in,status,categories));
        search="";
        in="";
        status="";
        categories.clear();
