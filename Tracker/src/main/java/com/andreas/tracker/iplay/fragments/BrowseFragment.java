...
public class BrowseFragment {
    ...
    @FXML
    private GridPane PaneCategories;
    @FXML
    private CheckBox CheckAppleMac;
    @FXML
    private CheckBox CheckApps;
    @FXML
    private CheckBox CheckForeign;
    @FXML
    private CheckBox CheckGamesPC;
    @FXML
    private CheckBox CheckGamesPS2;
    @FXML
    private CheckBox CheckGamesPS3;
    @FXML
    private CheckBox CheckGamesPSP;
    @FXML
    private CheckBox CheckGamesWii;
    @FXML
    private CheckBox CheckGamesX360;
    @FXML
    private CheckBox CheckLinuxUnix;
    @FXML
    private CheckBox CheckMSC;
    @FXML
    private CheckBox CheckMobileAppz;
    @FXML
    private CheckBox CheckMobileMovies;
    @FXML
    private CheckBox CheckMoviesAVIHD;
    @FXML
    private CheckBox CheckMoviesAVIHDRO;
    @FXML
    private CheckBox CheckMoviesBD;
    @FXML
    private CheckBox CheckMoviesBDRO;
    @FXML
    private CheckBox CheckMoviesDVDR;
    @FXML
    private CheckBox CheckMoviesDVDRRO;
    @FXML
    private CheckBox CheckMoviesHD;
    @FXML
    private CheckBox CheckMoviesHDRO;
    @FXML
    private CheckBox CheckMoviesPSP;
    @FXML
    private CheckBox CheckMoviesXVID;
    @FXML
    private CheckBox CheckSport;
    @FXML
    private CheckBox CheckTVBoxsets;
    @FXML
    private CheckBox CheckTVEpisodes;
    @FXML
    private CheckBox CheckTVHD;
    @FXML
    ...
    List<String> categories_tor=new ArrayList<String>();
    ...
    public void initialize() {
        ...
        PaneSearch.getChildren().remove(PaneCategories);
    ...
    public void createPagination() {
        if (TorrentsDB.getTorrentsNo("Browse", search, in, status, categories_tor)!=0) {
    ...
    public List<String> createPageIndex() {
        ...
        total_torrents = TorrentsDB.getTorrentsNo("Browse", search,in,status,categories_tor);
    ...
    public void showPageNo(int no_page, List<String> pages) {
        ...
        ObservableList<Torrent> listTorrents=FXCollections.observableArrayList(
                TorrentsDB.getTorrentsList("Browse", pages.get(no_page),search,in,status,categories_tor));
        search="";
        in="";
        status="";
        categories_tor.clear();
    ...
    public void filter() {
        ...
        List<CheckBox> categories_check= Arrays.asList(CheckAppleMac, CheckApps, CheckForeign, CheckGamesPC, CheckGamesPS2, CheckGamesPS3, CheckGamesPSP, CheckGamesWii,
                CheckGamesX360, CheckLinuxUnix, CheckMSC, CheckMobileAppz, CheckMobileMovies, CheckMoviesAVIHD, CheckMoviesAVIHDRO, CheckMoviesBD,
                CheckMoviesBDRO, CheckMoviesDVDR, CheckMoviesDVDRRO, CheckMoviesHD, CheckMoviesHDRO, CheckMoviesPSP, CheckMoviesXVID, CheckSport,
                CheckTVBoxsets, CheckTVEpisodes, CheckTVHD);
        List<String> categories_type=Arrays.asList("Apple","Apps","Foreign","Games.PC","Games.PS2","Games.PS3","Games.PSP"
                    ,"Games.Wii","Games.X360","Unix","MISC","Mobile.Appz","Mobile.Movies","AVI.HD","AVI.HD.RO","BD","BD.RO","DVDR"
                    ,"DVDR.RO","HD","HD.RO","PSP","XVID","Sport","TV.Boxsets","TV.Episodes","TV.HD");
        for (int i=0; i<categories_check.size();i++) {
            if (categories_check.get(i).isSelected()) {
                categories_tor.add(categories_type.get(i));
            }
        }
    ...
    public void categories(){
        if (!PaneSearch.getChildren().contains(PaneCategories)) {
            PaneSearch.getChildren().add(PaneCategories);
        } else {
            PaneSearch.getChildren().remove(PaneCategories);
        }
    }
