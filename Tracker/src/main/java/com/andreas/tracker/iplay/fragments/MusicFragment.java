...
public class MusicFragment {
    ...
    public void createPagination() {
        if (TorrentsDB.getTorrentsNo("Music", search, in, status, categories)!=0) {
    ...
    public List<String> createPageIndex() {
        ...
        total_torrents = TorrentsDB.getTorrentsNo("Music", search,in,status,categories);
    ...
    public void showPageNo(int no_page, List<String> pages) {
        ...
        ObservableList<Torrent> listTorrents= FXCollections.observableArrayList(
                TorrentsDB.getTorrentsList("Music", pages.get(no_page),search,in,status,categories));
        search="";
        in="";
        status="";
        categories.clear();
